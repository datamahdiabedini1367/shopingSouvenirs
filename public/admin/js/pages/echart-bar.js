$(function() {
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
                ...
                xAxis : [
                    {
                        type : 'category',
                        data : ['ژان','فور','مار','اور','مه','ژوئن','ژول','آگو','سپت','اوک','نوا','دسا']
                    }
                ],
                yAxis : [
                    {
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
                ...
                // Add legend
                legend: {
                    data: ['داده1', 'داده2', 'داده3', 'داده4', 'داده5']
                },
       ...
       //***************************
        ...
        var option = {
             ...
             // Setup grid
                ...
                // Add legend
                legend: {
                    data: [  'داده1', 'داده2', 'داده3', 'داده4', 'داده5', 'داده7']
                },
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
             ...
             // Setup grid
                ...
                yAxis: [{
                    type: 'category',
                    data: ['داده1', 'داده2', 'داده3', 'داده4', 'داده5', 'داده6']
                }],
