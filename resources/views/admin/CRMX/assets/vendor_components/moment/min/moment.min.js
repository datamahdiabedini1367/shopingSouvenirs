...
! function (a, b) {
	...
	function fb(a) {
		...
		if (b = a._i.replace(/\([^\)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s|\s$/g, ""), c = Ne.exec(b)) {
			if (d = c[1] ? "ddd" + (5 === c[1].length ? ", " : " ") : "", e = "D MMM " + (c[2].length > 10 ? "YYYY " : "YY "), f = "HH:mm" + (c[4] ? ":ss" : ""), c[1]) {
				var l = new Date(c[2]),
					m = ["Sun", "دو", "Tue", "Wed", "Thu", "Fri", "Sat"][l.getDay()];
	...
	var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
		pe = "ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژولای_آگوست_سپتامبر_اوکتبر_نوامبر_دسامبر".split("_"),
		qe = "ژان_فور_مار_آور_مه_ژوئن_ژول_آگو_سپت_اوک_نوا_دسا".split("_"),
		re = be,
		se = be;
	U("Y", 0, 0, function () {
		var a = this.year();
	...
	var ve = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنجشنبه_جمعه_شنبه".split("_"),
		we = "یک_دو_سه_چهار_پنج_جمعه_شنبه".split("_"),
