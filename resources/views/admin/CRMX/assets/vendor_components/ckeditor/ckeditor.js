...
(function () {
	...
	(function () {
		...
		CKEDITOR.addCss(".cke_editable{text-align:right; direction:rtl;font-family: 'IRANSansDN'; cursor:text}.cke_editable img,.cke_editable input,.cke_editable textarea{cursor:default}");
