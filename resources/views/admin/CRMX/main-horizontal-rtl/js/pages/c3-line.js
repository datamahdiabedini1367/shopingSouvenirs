...
$(function () {
    ...
    setTimeout(function() {
        o.load({
            columns: [
                ['داده1', 100, 250, 150, 200, 100, 350]
            ]
        })
    }, 1e3), setTimeout(function() {
        o.load({
            columns: [
                ['داده3', 80, 150, 100, 180, 80, 150]
            ]
        })
