    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "بیش از حد طولانی: حداکثر '" + $this.attr("maxlength") + "' کاراکتر<!-- data-validation-maxlength-message to override -->";
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "بیش از حد کوتاه: حداقل از '" + $this.attr("minlength") + "' کاراکتر<!-- data-validation-minlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "آدرس ایمیل نا معتبر<!-- data-validation-email-message to override -->";
        ...
        , validatorTypes: {
            ...
            , email: {
                ...
                , init: function ($this, name) {
                    ...
                    var message = "آدرس ایمیل نا معتبر";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    result.message = message;
            ...
            , maxlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "بیش از حد طولانی: حداکثر '" + result.maxlength + "' کاراکتر";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
            ...
            , minlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "بیش از حد کوتاه: حداقل از '" + result.minlength + "' کاراکتر";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
        ...
        , builtInValidators: {
            ...
            , required: {
                name: "Required"
                , type: "required"
                , message: "این مورد نیاز است<!-- data-validator-required-message to override -->"
            }
            , checkone: {
                name: "Checkone"
                , type: "minchecked"
