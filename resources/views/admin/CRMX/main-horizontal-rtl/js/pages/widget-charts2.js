...
$( document ).ready(function() {
	...
	if( $('#bar-chart2').length > 0 ){
		...
		var data2 = {
			labels: ["ژانویه", "فوریه", "مارس", "آوریل", "مه", "June", "July"],
			datasets: [
				{
	...
	if( $('#polar-chart2').length > 0 ){
		...
		var data4 = {
			datasets: [{
				...
				fontFamily: "IRANSansDN"// for legend
			}],
			labels: [
				"آزمایشگاه 1",
				"آزمایشگاه 2",
	...
	if( $('#radar-chart2').length > 0 ){
		...
		var data3 = {
			labels: ["غذا خوردن", "نوشیدن", "خوابیدن", "طراحی", "کدنویسی", "دوچرخه سواري", "دویدن"],
			datasets: [
				{
					label: "مجموعه داده اول من",
