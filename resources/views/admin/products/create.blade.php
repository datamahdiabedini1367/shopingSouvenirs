                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="نام محصول را وارد کنید" name="name" value="{{old('name')}}">
                                        </div>
                                    </div>
                                    <!--/span-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="قیمت را وارد کنید"
                                                       name="price" value="{{old('price')}}"></div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" max="100" class="form-control"
                                                       ...
                                                       value="{{old('percent')}}" name="percent"></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0"  class="form-control"
                                                       placeholder="موجودی انبار را وارد کنید" value="{{old('stock')}}" name="stock"></div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control p-20" rows="4" name="description" placeholder="توضیحات محصول را وارد کنید.">
                                                {{old('description')}}
                                            </textarea>
                                        </div>
                                    </div>
