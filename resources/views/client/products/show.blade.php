...
{{--                                            =====معادل اند=======--}}
                                ...
                                <div id="product">
                                    ...
                                    <div class="cart">
                                        ...
                                        <div>
                                            <button type="button" class="wishlist" id="like-{{$product->id}}" onClick="like({{$product->id}});"><i
                                                    class="fa fa-heart @if($product->is_liked) like @endif"></i> افزودن به علاقه مندی ها
                                            </button>
                                            <br/>
