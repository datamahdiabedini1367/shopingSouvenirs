                    ...
                    <div class="pull-left flip left-top">
                        <div class="links">
                            <ul>
                                ...
                                @auth
                                    <li><a href="{{route('client.likes.index')}}">لیست علاقه مندی
                                            (<span id="likes_count">{{auth()->user()->likes()->count()}}</span>)</a></li>
                                @endauth
...
<script>
    ...
    function delete_wish(productId) {
        $.ajax({
            type: 'DELETE',
            url: "/likes/"+productId,
            data: {
            ...
            success: function (data){
                console.log('runnig script');
                var likes_count = $('#likes_count');
                likes_count.text(data.likes_count);
                var  wish_row=$('#wish_row_'+productId);
                wish_row.remove();
