...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        <div class="card">
            ...
            <a href="{{route('auth.two.factor.deactivate')}}" class="btn btn-primary mt-5">
                @lang('auth.deactivate')
            </a>
            </div>
            @else
            <div class="card-body text-center">
                ...
                <a href="{{route('auth.two.factor.activate')}}" class="btn btn-primary mt-5">
                    @lang('auth.activate')
                </a>
            </div>
            @endif
